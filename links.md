...
All datasets shared on this page are freely available for academic use. Please cite the corresponding paper(s) if you use any of the data in your research.

本页分享的所有数据集均可免费用于学术研究，使用时请引用对应论文。
...
A comprehensive probabilistic two-way crosswalk between Chinese surname characters and their English spellings across multiple transliteration systems and dialect groups, designed to facilitate cross-language record linkage in Chinese migration and diaspora studies.
...
**Citation / 引用：** <br/>
Fanghao Chen, Ruichi Xiong, Xiaobo Zhang. Familiar Strangers: The Role of Diaspora Networks in Foreign Investment and Long-run Development. _Journal of International Economics_, 162, 104293. [[Paper](https://www.sciencedirect.com/science/article/abs/pii/S0022199626000838)]
